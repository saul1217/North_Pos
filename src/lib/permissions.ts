...
const rolePaths: Record<AuthUser["role"], string[]> = {
  admin: ["/pos/"],
  cajero: ["/pos/venta", "/pos/productos", "/pos/refacciones", "/pos/ventas", "/pos/apartados", "/pos/cotizaciones", "/pos/taller", "/pos/codigos-barras", "/pos/ayuda"],
  taller: ["/pos/taller", "/pos/productos", "/pos/refacciones", "/pos/inventario", "/pos/ayuda"],
};
